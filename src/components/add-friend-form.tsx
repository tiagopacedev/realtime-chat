  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-sm">
      ...
      <div className="mt-2 flex flex-col gap-2 md:flex-row">
        ...
        <Button type="submit" className="mt-2 w-full md:mt-0 md:w-auto" disabled={showSuccessState}>
          Send
        </Button>
      </div>
...
//       <div className="mt-2 flex flex-col gap-2 md:flex-row">
//         <Input {...register('email')} type="text" placeholder="Enter email" className="w-full" />
//         <Button type="submit" className="mt-2 w-full md:mt-0 md:w-auto">
//           Send
//         </Button>
//       </div>
